...
namespace Board {
  ...
  public class Point
  {
    ...
    // https://stackoverflow.com/questions/4598858/c-sharp-how-to-move-point-a-given-distance-d-and-get-a-new-coordinates
  ...
  public abstract class RegularPolygon
  {
    ...
    // Given a line segment 'line', indicates the point at which this polygon intersects that line segment
    // Returns null if no intersection exists
    public Point Intersection(LineSegment line) {
      foreach (LineSegment l in LineSegments) {
        Point i = l.Intersection(l);
        if (i != null)
          return i;
      }
      return null;
